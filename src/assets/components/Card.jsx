...
const Card = (props) => {
  return (
    <div className="bg-white shadow-lg p-4 flex flex-col relative w-[250px] rounded-2xl transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl">
